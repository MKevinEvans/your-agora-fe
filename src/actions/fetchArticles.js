...
export default function fetchArticles(searchTerm, currentUserId){
  ...
  return function(dispatch){
    ...
    $.ajax({
      url: `https://development-your-agora-api.herokuapp.com/search_terms`,
      type: 'POST',
      ...
      $.ajax({
        url: `https://development-your-agora-api.herokuapp.com/fetch_first_article`,
        type: 'POST',
        ...
        if (data.error === "RAWR")
          ...
          $.ajax({
            url: `https://development-your-agora-api.herokuapp.com/articles`,
            type: 'POST',
            data: JSON.stringify({search_term: searchTerm, current_user_id: currentUserId }),
            contentType: 'application/json; charset=utf-8',
            dataType: 'json'
